...
# 제거할 컬럼 리스트
columns_to_remove = ["신선 배아 사용 여부", "미세주입된 난자 수", "혼합된 난자 수", "배란 유도 유형"]
...
print(f"✅ 제거된 편향된 컬럼: {biased_columns}")  # 🔥 제거된 컬럼 출력
...
print(f"✅ 제거된 결측치 높은 컬럼(80% 이상): {high_missing_columns}")  # 🔥 제거된 결측치 컬럼 출력
